    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == BTSObservableObject.class) {
            switch (derivedFeatureID) {
                case BtsmodelPackage.BTS_CONFIGURATION__PROPERTY_CHANGE_SUPPORT:
                    return BtsmodelPackage.BTS_OBSERVABLE_OBJECT__PROPERTY_CHANGE_SUPPORT;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == AdministrativDataObject.class) {
            switch (derivedFeatureID) {
                case BtsmodelPackage.BTS_CONFIGURATION__STATE:
                    return BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__STATE;
                case BtsmodelPackage.BTS_CONFIGURATION__REVISION_STATE:
                    return BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISION_STATE;
                case BtsmodelPackage.BTS_CONFIGURATION__VISIBILITY:
                    return BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__VISIBILITY;
                case BtsmodelPackage.BTS_CONFIGURATION__REVISIONS:
                    return BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISIONS;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSDBBaseObject.class) {
            switch (derivedFeatureID) {
                case BtsmodelPackage.BTS_CONFIGURATION__REV:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__REV;
                case BtsmodelPackage.BTS_CONFIGURATION__PROJECT:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__PROJECT;
                case BtsmodelPackage.BTS_CONFIGURATION__LOCKED:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__LOCKED;
                case BtsmodelPackage.BTS_CONFIGURATION__UPDATERS:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__UPDATERS;
                case BtsmodelPackage.BTS_CONFIGURATION__READERS:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__READERS;
                case BtsmodelPackage.BTS_CONFIGURATION__DELETED:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__DELETED;
                case BtsmodelPackage.BTS_CONFIGURATION__CONFLICTING_REVS:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__CONFLICTING_REVS;
                case BtsmodelPackage.BTS_CONFIGURATION__DB_COLLECTION_KEY:
                    return BtsmodelPackage.BTSDB_BASE_OBJECT__DB_COLLECTION_KEY;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSNamedTypedObject.class) {
            switch (derivedFeatureID) {
                case BtsmodelPackage.BTS_CONFIGURATION__NAME:
                    return BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__NAME;
                case BtsmodelPackage.BTS_CONFIGURATION__TYPE:
                    return BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__TYPE;
                case BtsmodelPackage.BTS_CONFIGURATION__SORT_KEY:
                    return BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__SORT_KEY;
                case BtsmodelPackage.BTS_CONFIGURATION__SUBTYPE:
                    return BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__SUBTYPE;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSObject.class) {
            switch (derivedFeatureID) {
                case BtsmodelPackage.BTS_CONFIGURATION__CODE:
                    return BtsmodelPackage.BTS_OBJECT__CODE;
                case BtsmodelPackage.BTS_CONFIGURATION__RELATIONS:
                    return BtsmodelPackage.BTS_OBJECT__RELATIONS;
                case BtsmodelPackage.BTS_CONFIGURATION__TEMP_SORT_KEY:
                    return BtsmodelPackage.BTS_OBJECT__TEMP_SORT_KEY;
                case BtsmodelPackage.BTS_CONFIGURATION__EXTERNAL_REFERENCES:
                    return BtsmodelPackage.BTS_OBJECT__EXTERNAL_REFERENCES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == BTSObservableObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT__PROPERTY_CHANGE_SUPPORT:
                    return BtsmodelPackage.BTS_CONFIGURATION__PROPERTY_CHANGE_SUPPORT;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSIdentifiableItem.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTS_IDENTIFIABLE_ITEM__ID:
                    return BtsmodelPackage.BTS_CONFIGURATION__ID;
                default:
                    return -1;
            }
        }
        if (baseClass == AdministrativDataObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__STATE:
                    return BtsmodelPackage.BTS_CONFIGURATION__STATE;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISION_STATE:
                    return BtsmodelPackage.BTS_CONFIGURATION__REVISION_STATE;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__VISIBILITY:
                    return BtsmodelPackage.BTS_CONFIGURATION__VISIBILITY;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISIONS:
                    return BtsmodelPackage.BTS_CONFIGURATION__REVISIONS;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSDBBaseObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTSDB_BASE_OBJECT__REV:
                    return BtsmodelPackage.BTS_CONFIGURATION__REV;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__PROJECT:
                    return BtsmodelPackage.BTS_CONFIGURATION__PROJECT;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__LOCKED:
                    return BtsmodelPackage.BTS_CONFIGURATION__LOCKED;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__UPDATERS:
                    return BtsmodelPackage.BTS_CONFIGURATION__UPDATERS;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__READERS:
                    return BtsmodelPackage.BTS_CONFIGURATION__READERS;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__DELETED:
                    return BtsmodelPackage.BTS_CONFIGURATION__DELETED;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__CONFLICTING_REVS:
                    return BtsmodelPackage.BTS_CONFIGURATION__CONFLICTING_REVS;
                case BtsmodelPackage.BTSDB_BASE_OBJECT__DB_COLLECTION_KEY:
                    return BtsmodelPackage.BTS_CONFIGURATION__DB_COLLECTION_KEY;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSNamedTypedObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__NAME:
                    return BtsmodelPackage.BTS_CONFIGURATION__NAME;
                case BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__TYPE:
                    return BtsmodelPackage.BTS_CONFIGURATION__TYPE;
                case BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__SORT_KEY:
                    return BtsmodelPackage.BTS_CONFIGURATION__SORT_KEY;
                case BtsmodelPackage.BTS_NAMED_TYPED_OBJECT__SUBTYPE:
                    return BtsmodelPackage.BTS_CONFIGURATION__SUBTYPE;
                default:
                    return -1;
            }
        }
        if (baseClass == BTSObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTS_OBJECT__CODE:
                    return BtsmodelPackage.BTS_CONFIGURATION__CODE;
                case BtsmodelPackage.BTS_OBJECT__RELATIONS:
                    return BtsmodelPackage.BTS_CONFIGURATION__RELATIONS;
                case BtsmodelPackage.BTS_OBJECT__TEMP_SORT_KEY:
                    return BtsmodelPackage.BTS_CONFIGURATION__TEMP_SORT_KEY;
                case BtsmodelPackage.BTS_OBJECT__EXTERNAL_REFERENCES:
                    return BtsmodelPackage.BTS_CONFIGURATION__EXTERNAL_REFERENCES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == BTSObservableObject.class) {
            switch (baseOperationID) {
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT___ADD_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER:
                    return BtsmodelPackage.BTS_CONFIGURATION___ADD_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER;
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT___REMOVE_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER:
                    return BtsmodelPackage.BTS_CONFIGURATION___REMOVE_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == AdministrativDataObject.class) {
            switch (baseOperationID) {
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___ADD_REVISION__BTSREVISION:
                    return BtsmodelPackage.BTS_CONFIGURATION___ADD_REVISION__BTSREVISION;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___ADD_REVISION__INT_DATE_STRING:
                    return BtsmodelPackage.BTS_CONFIGURATION___ADD_REVISION__INT_DATE_STRING;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___GET_REVISION__INT:
                    return BtsmodelPackage.BTS_CONFIGURATION___GET_REVISION__INT;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___GET_LAST_REVISION:
                    return BtsmodelPackage.BTS_CONFIGURATION___GET_LAST_REVISION;
                default:
                    return -1;
            }
        }
