...
/**
 * This is the item provider adapter for a {@link org.bbaw.bts.btsmodel.BTSIdentifiableItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class BTSIdentifiableItemItemProvider
     ...
     * @generated
     */
    public BTSIdentifiableItemItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getStyledText(Object object) {
        String label = ((BTSIdentifiableItem) object).get_id();
        StyledString styledLabel = new StyledString();
        if (label == null || label.length() == 0) {
            styledLabel.append(getString("_UI_BTSIdentifiableItem_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(getString("_UI_BTSIdentifiableItem_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
