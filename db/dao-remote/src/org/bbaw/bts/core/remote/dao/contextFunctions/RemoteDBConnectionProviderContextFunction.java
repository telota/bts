...
public class RemoteDBConnectionProviderContextFunction extends ContextFunction {
    @Inject
    ...
    private RemoteDAOFactory loadDaoFactory(IEclipseContext context) throws CoreException {
        ...
        throw new BTSDBException("No DaoFactory found for DBConnectionProvider and factory name: " + daoFactoryName);
