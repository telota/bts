...
public class BTSWorkflowRuleItemProvider
    ...
    public Object getStyledText(Object object) {
        String label = ((BTSWorkflowRule) object).get_id();
        StyledString styledLabel = new StyledString();
        if (label == null || label.length() == 0) {
            styledLabel.append(getString("_UI_BTSWorkflowRule_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(getString("_UI_BTSWorkflowRule_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
