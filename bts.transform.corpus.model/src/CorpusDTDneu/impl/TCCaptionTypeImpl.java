...
public class TCCaptionTypeImpl extends MinimalEObjectImpl.Container implements TCCaptionType {
    ...
    public EList<TCPictureType> getTCPicture() {
        if (tCPicture == null) {
            tCPicture = new EObjectContainmentEList<>(TCPictureType.class, this, CorpusDTDneuPackage.TC_CAPTION_TYPE__TC_PICTURE);
        }
        return tCPicture;
    }
    ...
    public EList<String> getTCNotebook() {
        if (tCNotebook == null) {
            tCNotebook = new EDataTypeEList<>(String.class, this, CorpusDTDneuPackage.TC_CAPTION_TYPE__TC_NOTEBOOK);
        }
        return tCNotebook;
    }
