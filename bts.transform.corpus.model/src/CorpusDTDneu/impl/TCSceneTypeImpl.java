...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TC Scene Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCPassport <em>TC Passport</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCPicture <em>TC Picture</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCNotebook <em>TC Notebook</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getGroup <em>Group</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCCaption <em>TC Caption</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCScene <em>TC Scene</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCSuperText <em>TC Super Text</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCText <em>TC Text</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getAuthor <em>Author</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getSortKey <em>Sort Key</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCSceneTypeImpl#getTCName <em>TC Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TCSceneTypeImpl extends MinimalEObjectImpl.Container implements TCSceneType {
    /**
    ...
    protected EClass eStaticClass() {
        return CorpusDTDneuPackage.Literals.TC_SCENE_TYPE;
    }
    ...
    public void setTCPassport(TCPassportType newTCPassport) {
        if (newTCPassport != tCPassport) {
            ...
            if (tCPassport != null)
                msgs = ((InternalEObject) tCPassport).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PASSPORT, null, msgs);
            if (newTCPassport != null)
                msgs = ((InternalEObject) newTCPassport).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PASSPORT, null, msgs);
            msgs = basicSetTCPassport(newTCPassport, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PASSPORT, newTCPassport, newTCPassport));
    }
    ...
    public NotificationChain basicSetTCPassport(TCPassportType newTCPassport, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PASSPORT, oldTCPassport, newTCPassport);
    ...
    public FeatureMap getGroup() {
        if (group == null) {
            group = new BasicFeatureMap(this, CorpusDTDneuPackage.TC_SCENE_TYPE__GROUP);
        }
        return group;
    }
    ...
    public EList<TCCaptionType> getTCCaption() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_SCENE_TYPE__TC_CAPTION);
    }
    ...
    public EList<TCSceneType> getTCScene() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_SCENE_TYPE__TC_SCENE);
    }
    ...
    public EList<TCSuperTextType> getTCSuperText() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_SCENE_TYPE__TC_SUPER_TEXT);
    }
    ...
    public EList<TCTextType> getTCText() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_SCENE_TYPE__TC_TEXT);
    }
    ...
    public void setAuthor(Object newAuthor) {
        ...
        author = newAuthor;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_SCENE_TYPE__AUTHOR, oldAuthor, author));
    }
    ...
    public void setSortKey(Object newSortKey) {
        ...
        sortKeyESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_SCENE_TYPE__SORT_KEY, oldSortKey, sortKey, !oldSortKeyESet));
    }
    ...
    public void unsetSortKey() {
        ...
        sortKeyESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CorpusDTDneuPackage.TC_SCENE_TYPE__SORT_KEY, oldSortKey, SORT_KEY_EDEFAULT, oldSortKeyESet));
    }
    ...
    public void setTCName(Object newTCName) {
        ...
        tCName = newTCName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_SCENE_TYPE__TC_NAME, oldTCName, tCName));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PASSPORT:
                return basicSetTCPassport(null, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PICTURE:
                return ((InternalEList<?>) getTCPicture()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__GROUP:
                return ((InternalEList<?>) getGroup()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_CAPTION:
                return ((InternalEList<?>) getTCCaption()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_SCENE:
                return ((InternalEList<?>) getTCScene()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_SUPER_TEXT:
                return ((InternalEList<?>) getTCSuperText()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_TEXT:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_PICTURE:
                return getTCPicture();
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_NOTEBOOK:
            ...
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_TEXT:
                return getTCText();
            case CorpusDTDneuPackage.TC_SCENE_TYPE__AUTHOR:
                return getAuthor();
            case CorpusDTDneuPackage.TC_SCENE_TYPE__SORT_KEY:
                return getSortKey();
            case CorpusDTDneuPackage.TC_SCENE_TYPE__TC_NAME:
                return getTCName();
        }
