...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TC Arrangement Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCPassport <em>TC Passport</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCPicture <em>TC Picture</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCNotebook <em>TC Notebook</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getGroup <em>Group</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCArrangement <em>TC Arrangement</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCObject <em>TC Object</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getAuthor <em>Author</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getSortKey <em>Sort Key</em>}</li>
 * <li>{@link CorpusDTDneu.impl.TCArrangementTypeImpl#getTCName <em>TC Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TCArrangementTypeImpl extends MinimalEObjectImpl.Container implements TCArrangementType {
    /**
     ...
     * @generated
     */
    protected TCArrangementTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CorpusDTDneuPackage.Literals.TC_ARRANGEMENT_TYPE;
    }
    ...
    public void setTCPassport(TCPassportType newTCPassport) {
        if (newTCPassport != tCPassport) {
            ...
            if (tCPassport != null)
                msgs = ((InternalEObject) tCPassport).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_PASSPORT, null, msgs);
            if (newTCPassport != null)
                msgs = ((InternalEObject) newTCPassport).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_PASSPORT, null, msgs);
            msgs = basicSetTCPassport(newTCPassport, msgs);
            if (msgs != null) msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_PASSPORT, newTCPassport, newTCPassport));
    }
    ...
    public NotificationChain basicSetTCPassport(TCPassportType newTCPassport, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_PASSPORT, oldTCPassport, newTCPassport);
    ...
    public FeatureMap getGroup() {
        if (group == null) {
            group = new BasicFeatureMap(this, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__GROUP);
        }
        return group;
    }
    ...
    public EList<TCArrangementType> getTCArrangement() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_ARRANGEMENT_TYPE__TC_ARRANGEMENT);
    }
    ...
    public EList<TCObjectType> getTCObject() {
        return getGroup().list(CorpusDTDneuPackage.Literals.TC_ARRANGEMENT_TYPE__TC_OBJECT);
    }
    ...
    public void setAuthor(Object newAuthor) {
        ...
        author = newAuthor;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__AUTHOR, oldAuthor, author));
    }
    ...
    public void setSortKey(Object newSortKey) {
        ...
        sortKeyESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__SORT_KEY, oldSortKey, sortKey, !oldSortKeyESet));
    }
    ...
    public void unsetSortKey() {
        ...
        sortKeyESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__SORT_KEY, oldSortKey, SORT_KEY_EDEFAULT, oldSortKeyESet));
    }
    ...
    public void setTCName(Object newTCName) {
        ...
        tCName = newTCName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_NAME, oldTCName, tCName));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__GROUP:
                return ((InternalEList<?>) getGroup()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_ARRANGEMENT:
                return ((InternalEList<?>) getTCArrangement()).basicRemove(otherEnd, msgs);
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_OBJECT:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_PICTURE:
                return getTCPicture();
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_NOTEBOOK:
            ...
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_OBJECT:
                return getTCObject();
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__AUTHOR:
                return getAuthor();
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__SORT_KEY:
                return getSortKey();
            case CorpusDTDneuPackage.TC_ARRANGEMENT_TYPE__TC_NAME:
                return getTCName();
        }
