...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Category Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see CorpusDTDneu.CorpusDTDneuPackage#getCategoryType1()
 * @model extendedMetaData="name='Category_._1_._type'"
 * @generated
 */
public enum CategoryType1 implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>Museum</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #MUSEUM_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>Museum</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Museum</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #MUSEUM
	 ...
	 * @ordered
	 */
	public static final int MUSEUM_VALUE = 7;

	/**
	 * An array of all the '<em><b>Category Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final CategoryType1[] VALUES_ARRAY =
		new CategoryType1[] {
			PROVENANCE,
			DATE,
			OBJECT_TYPE,
	...
	/**
	 * A public read-only list of all the '<em><b>Category Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<CategoryType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Category Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Category Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Category Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static CategoryType1 get(int value) {
		switch (value) {
			case PROVENANCE_VALUE: return PROVENANCE;
			case DATE_VALUE: return DATE;
			case OBJECT_TYPE_VALUE: return OBJECT_TYPE;
			case DEPICTION_VALUE: return DEPICTION;
			case SCRIPT_VALUE: return SCRIPT;
			case LANGUAGE_VALUE: return LANGUAGE;
			case TEXT_TYPE_VALUE: return TEXT_TYPE;
			case MUSEUM_VALUE: return MUSEUM;
		}
		return null;
	}
