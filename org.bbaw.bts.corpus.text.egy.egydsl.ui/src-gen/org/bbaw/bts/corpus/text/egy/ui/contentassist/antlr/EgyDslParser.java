		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEmendationVersMarkerAccess().getGroup(), "rule__EmendationVersMarker__Group__0");
					...
					put(grammarAccess.getDestroyedVersFrontierMarkerAccess().getGroup(), "rule__DestroyedVersFrontierMarker__Group__0");
					put(grammarAccess.getPartialDestroyedVersMarkerAccess().getGroup(), "rule__PartialDestroyedVersMarker__Group__0");
