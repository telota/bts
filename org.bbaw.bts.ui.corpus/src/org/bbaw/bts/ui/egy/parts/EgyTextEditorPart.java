...
public class EgyTextEditorPart extends AbstractTextEditorLogic implements IBTSEditor, EventHandler {
	...
	@Inject @Preference(value = BTSEGYUIConstants.PREF_TRANSLITERATION_EDITOR_SHOW_LINE_NUMBER_RULER, nodePath = "org.bbaw.bts.ui.corpus")
    ...
    private void refreshAnnotations() {
        ...
        /* Dumbly add everything here. There should not be many of these annotations or these events so the impact of
