...
public class SignTextComposite extends Composite {
	...
	@Inject
	@Preference(value = BTSEGYUIConstants.SIGN_TEXT_SHOW_HIEROGLYPHS, nodePath = "org.bbaw.bts.ui.corpus")
	private Boolean showHieroglyphs;
	
	@Inject
	@Preference(value = BTSEGYUIConstants.SIGN_TEXT_SHOW_FLEXION, nodePath = "org.bbaw.bts.ui.corpus")
	private Boolean showFlexion;
	
	@Inject
	@Preference(value = BTSEGYUIConstants.SIGN_TEXT_SHOW_LEMMAID, nodePath = "org.bbaw.bts.ui.corpus")
	private Boolean showLemmaId;
	
	@Inject
	@Preference(nodePath = "org.bbaw.bts.ui.corpus")
	IEclipsePreferences preferences;

	private Integer showTransLangMask = 0;

	@Inject
	@Preference(value = BTSEGYUIConstants.SIGN_TEXT_SHOW_LINE_WIDTH, nodePath = "org.bbaw.bts.ui.corpus")
	private Integer max_line_length;
	

	@Inject
	@Preference(value = BTSEGYUIConstants.PREF_LEMMATIZER_FELXION_DEFAULT, nodePath = "org.bbaw.bts.ui.corpus")
