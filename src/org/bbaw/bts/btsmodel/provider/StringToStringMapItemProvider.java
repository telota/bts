...
/**
 * This is the item provider adapter for a {@link java.util.Map} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class StringToStringMapItemProvider
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                BtsmodelPackage.Literals.STRING_TO_STRING_MAP__KEY,
                                true,
                                false,
                                false,
        ...
        itemPropertyDescriptors.add
                (createItemPropertyDescriptor
                        (((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                                ...
                                BtsmodelPackage.Literals.STRING_TO_STRING_MAP__VALUE,
                                true,
                                false,
                                false,
                                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(getString("_UI_StringToStringMap_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(getString("_UI_StringToStringMap_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
