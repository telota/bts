...
import org.bbaw.bts.ui.main.parts.ConflictsPart;
...
public class ConflictsDialog extends TitleAreaDialog {
    @Inject
    private IEclipseContext context;
    @Inject
    private EPartService partService;
    private ConflictsPart part;
    ...
    public ConflictsDialog() {
        super(new Shell());
        System.out.println("construct Conflicts Dialog");
     ...
     * @param parentShell
     */
    public ConflictsDialog(Shell parentShell) {
        super(parentShell);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        IEclipseContext child = context.createChild("conflictsDialog");
        child.set(Composite.class, area);
        part = ContextInjectionFactory.make(ConflictsPart.class, child);
        //		area.layout();
        parent.layout();
        area.layout();
        return area;
