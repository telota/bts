...
/**
 * This is the item provider adapter for a {@link org.bbaw.bts.corpus.btsCorpusModel.BTSAmbivalence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BTSAmbivalenceItemProvider
	 ...
	 * @generated
	 */
	public BTSAmbivalenceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BtsCorpusModelPackage.Literals.BTS_AMBIVALENCE__CASES);
		}
	...
	/**
	 * This returns BTSAmbivalence.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BTSAmbivalence"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_BTSAmbivalence_type") :
			label;
	}
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			...
			styledLabel.append(getString("_UI_BTSAmbivalence_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
