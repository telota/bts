...
public class View {
     ...
     * @param param       The request parameter to use to query a page, or {@code null}
    ...
    /**
     * @param key The key value, accepts a single value or multiple values for
     *            complex keys.
     */
    ...
    /**
     * @param startKey The start key value, accepts a single value or multiple values
     *                 for complex keys.
     */
    ...
    /**
     * @param endKey The end key value, accepts a single value or multiple values
     *               for complex keys.
     */
    ...
    /**
     * @param stale Accept values: ok | update_after (update_after as of CouchDB
     *              1.1.0)
     */
    ...
    /**
     * @param group Specifies whether the reduce function reduces the result to a
