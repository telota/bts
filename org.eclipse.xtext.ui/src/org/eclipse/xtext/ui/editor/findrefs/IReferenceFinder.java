...
public interface IReferenceFinder {
     ...
     *
     * @param targetURIs          the URIs of the target elements of the references. Should be normalized.
     * @param sourceResourceURIs  the search scope for the resources containing the sources of the references.
     * @param localResourceAccess used to find local references. If null, only indexed references are returned.
     * @param referenceAcceptor   accepts the matches.
