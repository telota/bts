...
public class ListDialogField extends DialogField {
     ...
     *
     * @param adapter      A listener for button invocation, selection changes. Can be
     *                     <code>null</code>.
     * @param buttonLabels The labels of all buttons: <code>null</code> is a valid array
    ...
    /**
     * A special composite to layout columns inside a table. The composite is
     * needed since we have to layout the columns "before" the actual table gets
     * layouted. Hence we can't use a normal layout manager.
     * <p>
     * Should switch to use {@link org.eclipse.jface.layout.TableColumnLayout}.
     * </p>
     */
    static class TableLayoutComposite extends Composite {

        /**
         * The number of extra pixels taken as horizontal trim by the table
         * column. To ensure there are N pixels available for the content of the
         * column, assign N+COLUMN_TRIM for the column width.
         * <p>
         * Should either switch to use
         * {@link org.eclipse.jface.layout.TableColumnLayout} or get API from
         * JFace or SWT, see:
         * https://bugs.eclipse.org/bugs/show_bug.cgi?id=218483
         * </p>
         *
         * @since 3.1
         */
