        ...
        if (baseClass == BTSObservableObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT__PROPERTY_CHANGE_SUPPORT:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM__PROPERTY_CHANGE_SUPPORT;
                default:
                    return -1;
            }
        }
        if (baseClass == AdministrativDataObject.class) {
            switch (baseFeatureID) {
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__STATE:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM__STATE;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISION_STATE:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM__REVISION_STATE;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__VISIBILITY:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM__VISIBILITY;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT__REVISIONS:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM__REVISIONS;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == BTSObservableObject.class) {
            switch (baseOperationID) {
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT___ADD_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___ADD_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER;
                case BtsmodelPackage.BTS_OBSERVABLE_OBJECT___REMOVE_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___REMOVE_PROPERTY_CHANGE_LISTENER__PROPERTYCHANGELISTENER;
                default:
                    return -1;
            }
        }
        if (baseClass == AdministrativDataObject.class) {
            switch (baseOperationID) {
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___ADD_REVISION__BTSREVISION:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___ADD_REVISION__BTSREVISION;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___ADD_REVISION__INT_DATE_STRING:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___ADD_REVISION__INT_DATE_STRING;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___GET_REVISION__INT:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___GET_REVISION__INT;
                case BtsmodelPackage.ADMINISTRATIV_DATA_OBJECT___GET_LAST_REVISION:
                    return BtsCorpusModelPackage.BTS_TEXT_SENTENCE_ITEM___GET_LAST_REVISION;
                default:
                    return -1;
            }
        }
