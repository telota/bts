...
public class LanguageAwareMarkerTypeProvider extends MarkerTypeProvider {
    ...
    public void initialize(LanguageInfo languageInfo, AbstractUIPlugin uiPlugin) {
        ...
        setMarkerTypes(bundleName + "org.bbaw.bts.core.services.corpus.impl/META-INF" + languageName);
    }
    ...
    public String getMarkerType(Issue issue) {
        ...
        switch (type) {
            case FAST:
                return fastValidationMarker;
            case NORMAL:
                return normalValidationMarker;
            case EXPENSIVE:
                return expensiveValidationMarker;
            default:
                throw new IllegalStateException("issue.getType was " + issue.getType());
        }
    }
