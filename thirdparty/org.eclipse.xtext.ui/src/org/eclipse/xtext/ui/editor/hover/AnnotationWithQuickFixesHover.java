...
//			System.out.println(str);
        ...
        public boolean canReuse(IInformationControl control) {
            ...
            if (control instanceof IInformationControlExtension4)
                ((IInformationControlExtension4) control).setStatusText("org.bbaw.bts.core.remote.dao.couchDB/src/test");  //EditorsUI.getTooltipAffordanceString())  XXX cp uncommented
