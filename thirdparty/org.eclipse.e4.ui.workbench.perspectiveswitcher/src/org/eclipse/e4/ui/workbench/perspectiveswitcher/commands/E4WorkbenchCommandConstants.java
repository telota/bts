...
public interface E4WorkbenchCommandConstants {
     ...
     */
    String CATEGORY_PERSPECTIVES = "org.eclipse.e4.ui.perspectives"; //$NON-NLS-1$

    /**
     * Name for category "Perspectives"
     * (value is <code>"Perspectives Category"</code>).
     */
    String CATEGORY_PERSPECTIVES$_NAME = "Perspectives"; //$NON-NLS-1$

    /**
     * Description for category "Perspectives"
     * (value is <code>"Manipulation of workbench perspectives"</code>).
     */
    String CATEGORY_PERSPECTIVES$_DESCRIPTION = "Manipulation of workbench perspectives"; //$NON-NLS-1$
     ...
     */
    String PERSPECTIVES_SHOW_TEXT$_DESCRIPTION = "Displays the perspective name next to its icon"; //$NON-NLS-1$
