 ...
 * </p>
 * <ul>
 * <li>{@link org.bbaw.bts.corpus.text.egy.egyDsl.impl.PartialDestructionImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PartialDestructionImpl extends BracketsImpl implements PartialDestruction {
    ...
    protected EClass eStaticClass() {
        return EgyDslPackage.Literals.PARTIAL_DESTRUCTION;
    }
    ...
    public EList<NoPartialDestruction> getWChar() {
        if (wChar == null) {
            wChar = new EObjectContainmentEList<NoPartialDestruction>(NoPartialDestruction.class, this, EgyDslPackage.PARTIAL_DESTRUCTION__WCHAR);
        }
        return wChar;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EgyDslPackage.PARTIAL_DESTRUCTION__WCHAR:
