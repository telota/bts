 ...
 * </p>
 * <ul>
 * <li>{@link org.bbaw.bts.corpus.text.egy.egyDsl.impl.DisputableReadingImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DisputableReadingImpl extends BracketsImpl implements DisputableReading {
    ...
    protected EClass eStaticClass() {
        return EgyDslPackage.Literals.DISPUTABLE_READING;
    }
    ...
    public EList<NoDisputableReading> getWChar() {
        if (wChar == null) {
            wChar = new EObjectContainmentEList<NoDisputableReading>(NoDisputableReading.class, this, EgyDslPackage.DISPUTABLE_READING__WCHAR);
        }
        return wChar;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EgyDslPackage.DISPUTABLE_READING__WCHAR:
