 ...
 * </p>
 * <ul>
 * <li>{@link org.bbaw.bts.corpus.text.egy.egyDsl.impl.DeletionImpl#getWChar <em>WChar</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeletionImpl extends BracketsImpl implements Deletion {
    /**
     ...
     * @see #getWChar()
     */
    protected EList<NoDeletion> wChar;
    ...
    protected EClass eStaticClass() {
        return EgyDslPackage.Literals.DELETION;
    }
     ...
     * @generated
     */
    public EList<NoDeletion> getWChar() {
        if (wChar == null) {
            wChar = new EObjectContainmentEList<NoDeletion>(NoDeletion.class, this, EgyDslPackage.DELETION__WCHAR);
        }
        return wChar;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EgyDslPackage.DELETION__WCHAR:
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            case EgyDslPackage.DELETION__WCHAR:
                getWChar().clear();
                getWChar().addAll((Collection<? extends NoDeletion>) newValue);
                return;
        }
