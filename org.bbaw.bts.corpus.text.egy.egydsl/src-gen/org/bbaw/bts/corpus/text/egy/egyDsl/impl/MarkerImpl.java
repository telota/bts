...
public class MarkerImpl extends AbstractMarkerImpl implements Marker {
    ...
    protected EClass eStaticClass() {
        return EgyDslPackage.Literals.MARKER;
    }
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EgyDslPackage.MARKER__TYPE, oldType, type));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EgyDslPackage.MARKER__TYPE:
                return getType();
        }
